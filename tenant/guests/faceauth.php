...
if (isset($_POST['start_over'])) {
    ...
    $stmt = $con->prepare('DELETE FROM guests WHERE id = ?');
...
<?php endif; ?>
    <button name="run_face_auth" onclick="enrollNewUser()">Run Guest Face Auth</button>
<form action="faceauth.php" method="post">
    <button type="submit" name="start_over">Start Over Guest Registration</button>
</form>
    ...
    <script type="text/javascript">
        ...
        function enrollNewUser(){
           ...
           faceio.enroll({
                ...
                alert(
                    `Success! Guest is now recorded. You will be redirected back to homepage.`
                );
